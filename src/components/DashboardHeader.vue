      ...
      <link v-if="getpath != '/'" href="/src/assets/css/responsive.css" rel="stylesheet" defer>
        ...
        <nav class="navbar navbar-expand-lg " id="">
            <div v-if="getpath != '/'" class="container custom_container">
                ...
                <button class="navbar-toggler" v-on:click="this.togglebar" type="button" data-trigger="#main_nav"><i class="fas fa-bars"></i></button>
                
                <div :class="'navbar-collapse '+this.showtoggle()" id="main_nav">   
                    <div class="offcanvas-header mt-3">
                        <button class="btn  btn-close float-right" v-on:click="this.togglebar"><i class="fas fa-times"></i></button>
                    </div>
