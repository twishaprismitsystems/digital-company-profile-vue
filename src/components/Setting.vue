	...
	<div class="container-fluid ">
		...
		<div class=" right_sidebar_content" v-if="getpagerequest == 1">
			<div class="tabs-stage">
                ...
                <router-link to="/admindashboard/addtheme" type="button" class="btnBack site_btn btn_000 btncol"><i class="fas fa-arrow-left"></i>Back</router-link>
			    <div class="tab_title">
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-12 mt-5">
                      ...
                      <ul class="nav nav-tabs tabstyle" role="tablist">
                            <li class="nav-item">
                                <a @click="changepanel('site')" :class="curpage == 'site' ? 'nav-link active' : 'nav-link'" data-toggle="tab"  role="tab">Site Setting</a>
                            </li>
                            <li class="nav-item">
                                <a @click="changepanel('gcode')" :class="curpage == 'gcode' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Google Analytics Code</a>
                            </li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div :class="curpage == 'site' ? 'tab-pane active' : 'tab-pane'" role="tabpanel">
                            ...
                            <div :class="curpage == 'gcode' ? 'tab-pane active' : 'tab-pane'" class="tab-pane"  role="tabpanel">
