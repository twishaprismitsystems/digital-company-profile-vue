...
<div>
    ...
    <ul class="nav nav-tabs tabstyle" role="tablist">
        <li class="nav-item">
            <a @click="changepanel('home')" :class="curpage == 'home' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Home</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('steps')" :class="curpage == 'steps' ? 'nav-link active' : 'nav-link'" data-toggle="tab"  role="tab">Steps</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('card')" :class="curpage == 'card' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Card</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('feature')" :class="curpage == 'feature' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Feature</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('faq')" :class="curpage == 'faq' ? 'nav-link active' : 'nav-link'" data-toggle="tab"  role="tab">FAQ</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('freetrail')" :class="curpage == 'freetrail' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Free Trail</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('review')" :class="curpage == 'review' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Review</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('contact')" :class="curpage == 'contact' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Contact</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('pages')" :class="curpage == 'pages' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Pages</a>
        </li>
        <li class="nav-item">
            <a @click="changepanel('seo')" :class="curpage == 'seo' ? 'nav-link active' : 'nav-link'" data-toggle="tab" role="tab">Seo</a>
        </li>
    </ul>
